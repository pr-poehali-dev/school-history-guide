...
import WorldWarOneTests from "./pages/WorldWarOneTests";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/class/10/history/tests" element={<HistoryTests />} />
          <Route path="/class/10/history/timeline" element={<HistoryTimeline />} />
          ...
          <Route path="/class/10/history/chapter-1/world-war-one/tests" element={<WorldWarOneTests />} />
